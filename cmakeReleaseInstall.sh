...
show_help() {
    echo "Usage: cmakeReleaseInstall.sh -d installDir -c yumCacheDir pkg1 pkg2..."
    echo "Example: ./cmakeReleaseInstall.sh -d <installation_location> -c <cache_location like /tmp/$USER/rpms> AtlasOffline_21.0.0_x86_64-slc6-gcc49-opt"
}
